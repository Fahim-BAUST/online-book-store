...
const Header = () => {
    return (
        <div className="sticky-top shadow ">
            <nav className="navbar bg-secondary bg-opacity-10 navbar-expand-lg navbar-light  text-dark ">
                <div className="container-fluid">
                    <NavLink
                        className="navbar-brand "
                        to="/home"
                    >
                        <img style={{ width: "130px", height: "40px" }} className="img-fluid" src="https://i.ibb.co/cyRQvCT/coollogo-com-269541991.gif" alt="" />
                    </NavLink>
