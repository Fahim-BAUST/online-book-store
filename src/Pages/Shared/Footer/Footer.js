        ...
        <div>
            ...
            <div className="container mt-5">
                <div className="row">
                    <div className="col">
                        <div className="col">
                            ...
                            <h5><i className="fas fa-user"></i> Hotline</h5>
                            <ul>
                                <li>o1XXXXXXXXXX</li>
                                <li>o1XXXXXXXXXX</li>
                                <li>o1XXXXXXXXXX</li>
                            ...
                            <h5><i className="far fa-handshake"></i> Corporate Sales</h5>
                            <ul>
                                <li>o1XXXXXXXXXX</li>
                                <li>o1XXXXXXXXXX</li>
                                <p>(9AM to 6PM)</p>
                            ...
                            <p><i class="far fa-envelope"></i><Link to="/#">admin@gmail.com</Link>
                            </p>
                            <p><i className="fas fa-home"></i> 2/1/E, Eden Center, Arambag, Motijheel, Dhaka-1000</p>
                ...
                <div className="row text-center mt-2">
                    ...
                    <p>bookstore103 is now one of the leading e-commerce organizations in Bangladesh. It is indeed the biggest online bookshop or bookstore in Bangladesh that helps you save time and money. You can buy books online with a few clicks or a convenient phone call. With breathtaking discounts and offers you can buy anything from Bangla Upannash or English story books to academic, research or competitive exam books. Superfast cash on delivery service brings the products at your doorstep. Our customer support, return and replacement policies will surely add extra confidence in your online shopping experience. Happy Shopping with bookstore103!</p>
                </div>
                <div className=" container text-center">
                    © 2021-2022 https://bookstore-9683d.web.app/
                </div>
            </div>
